...
export const metadata: Metadata = {
  title: 'Arsalan Academy - IT Training and Solutions',
  description: 'We empower engineers and teams with the skills to build, deploy, and maintain modern IT infrastructure.',
  alternates: {
    canonical: '/'
  }
}
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row mt-6">
                <Button asChild className="bg-[#27c6d9] hover:bg-[#1ea8b9] text-black">
                  <Link href="https://calendly.com/arsalan-academy/" target="_blank" rel="noopener noreferrer">Book Now</Link>
                </Button>
              </div>
            </div>
          </div>
