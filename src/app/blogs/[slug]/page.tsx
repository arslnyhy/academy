    ...
    <div className="flex flex-col min-h-screen">
      <div className="container px-4 py-12 md:py-24 lg:py-32">
        <div className="flex flex-col items-center justify-center p-12 border rounded-lg text-center">
          <h1 className="text-2xl font-bold text-primary mb-4">Coming Soon!</h1>
          <p className="text-muted-foreground max-w-[600px] mb-8">
            We&apos;re working on creating valuable blog posts about network automation, best practices, and industry insights. 
